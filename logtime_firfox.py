...
def setup():
    ...
    # options.add_argument('--disable-gpu')  # Disable GPU acceleration for better compatibility
    # options.add_argument('--window-size=1920x1080')  # Set the window size to avoid certain headless issues
...
def login(driver, username, password):
    ...
    username_field.screenshot('element_screenshot.png')
