                    ...
                    if roles:
                        ...
                        for role in roles:
                            try:
                                ...
                                location_elements = role.find_elements(By.XPATH, ".//p[contains(@class, 'experience-item__meta-item')]")
                        ...
                        try:
                            ...
                            location_elements = section.find_elements(By.XPATH, ".//p[contains(@class, 'experience-item__meta-item')]")
                            location = location_elements[-1].text if location_elements else "N/A"
                            experiences.append(f"{job_title} at {company_name} ({date_range}, {location})")
